--PLEASE NOTE THAT TABLE NAME USED IN THIS CODE IS ```sagas_movies_weekend``` SORRY
...
--This will give the movies their associated genres	
INSERT INTO junction (movies_id, genres_id)
VALUES(1,7),(1,11),
(2,9),(2,10),(2,8),
(3,13),
(4,1),(4,2),
